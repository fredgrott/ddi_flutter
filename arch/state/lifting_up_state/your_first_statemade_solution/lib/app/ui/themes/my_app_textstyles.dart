...
TextStyle mySnackbarTextStyle = TextStyle();

TextStyle myTabbarLabelTextStyle = TextStyle();

TextStyle myTabbarUnselectedLabelTextStyle = TextStyle();

TextStyle myTooltipTextStyle = TextStyle();

TextStyle myTimePickerHelpTextStyle = TextStyle();

TextStyle myTimePickerHourTextStyle = TextStyle();
...
TextStyle myTimePickerDayTextStyle = TextStyle();

TextStyle myTextFieldTextStyle = TextStyle();

StrutStyle myTextFieldStrutStyle = StrutStyle();

TextStyle myTextFormFieldTextStyle = TextStyle();

StrutStyle myTextFormFieldStrutStyle = StrutStyle();

TextStyle myCupertinoDialogActionTextStyle = TextStyle();

TextStyle myUnselectedLabelStyle = TextStyle();

TextStyle mySelectedLabelStyle = TextStyle();

TextStyle myBannerContentTextStyle = TextStyle();
