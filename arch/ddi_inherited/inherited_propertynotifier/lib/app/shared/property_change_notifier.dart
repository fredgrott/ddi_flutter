...
class PropertyChangeNotifier<T extends Object> extends ChangeNotifier {
  ...
  Map<T, ObserverList<Function>>? _propertyListeners =
      <T, ObserverList<Function>>{};

  /// Re-implemented from [ChangeNotifier].
  ...
  void addListener(Function listener, [Iterable<T>? properties]) {
    assert(_debugAssertNotDisposed());
    assert(listener is VoidCallback || listener is PropertyCallback<T>,
