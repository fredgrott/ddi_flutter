...
import 'package:inherited_model_example/app/domain/models/countermodel.dart';
import 'package:inherited_model_example/app/myapp.dart';

import 'package:inherited_model_example/app/shared/app_vars.dart';
import 'package:inherited_model_example/app/shared/build_modes.dart';
import 'package:inherited_model_example/app/shared/catcher.dart';
...
Future<Null> main() async {
  ...
  runZonedGuarded<Future<Null>>(
    () async {
      ...
      Catcher(
        rootWidget: MyApp(navigatorKey, CounterModel()),
