...
import 'package:inherited_stateprovider/app/ui/themes/my_cupertino_page_scaffold_data.dart';
import 'package:inherited_stateprovider/app/ui/themes/my_material_app_bar_data.dart';
import 'package:inherited_stateprovider/app/ui/themes/my_material_iconbutton_data.dart';
import 'package:inherited_stateprovider/app/ui/themes/my_material_scaffold_data.dart';
            ...
            body: Stack(children: <Widget>[
              Card(child:Center(
                ...
                children: <Widget>[
                  ...
                  PlatformText(
                    '${counterProvider.counter.count}', key: const Key('text'), textAlign: TextAlign.center, softWrap: true, overflow: TextOverflow.clip, textScaleFactor: 1.0, maxLines: 1, semanticsLabel: 'counter value',
                  ),
                ],
              ),), ),
