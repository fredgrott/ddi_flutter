...
import 'package:distate_setup/app/shared/build_modes.dart';
import 'package:distate_setup/app/shared/catcher.dart';
import 'package:distate_setup/app/shared/logging_strategies.dart';
...
Future<Null> main() async {
  ...
  runZonedGuarded<Future<Null>>(
    () async {
      ...
      // we do not use the states rebuilder transitions as we keep transitions platform unique
